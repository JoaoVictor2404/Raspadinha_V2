...
export const deliveriesStatusEnum = mysqlEnum("delivery_status", [
  "pending",
  "processing",
  "shipped",
  "delivered",
...
export const deliveries = mysqlTable("deliveries", {
  ...
  status: deliveriesStatusEnum("status").notNull().default("pending"),
...
export const wallets = mysqlTable("wallets", {
  id: varchar("id", { length: 36 }).primaryKey(),
  userId: varchar("user_id", { length: 36 }).notNull().unique(),
  balanceTotal: decimal("balance_total", { precision: 10, scale: 2 })
    .notNull()
    .default("0.00"),
  balanceStandard: decimal("balance_standard", { precision: 10, scale: 2 })
    .notNull()
    .default("0.00"),
  balancePrizes: decimal("balance_prizes", { precision: 10, scale: 2 })
    .notNull()
    .default("0.00"),
  balanceBonus: decimal("balance_bonus", { precision: 10, scale: 2 })
    .notNull()
    .default("0.00"),
  updatedAt: datetime("updated_at").notNull().defaultNow()
});
